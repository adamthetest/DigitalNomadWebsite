...
class PHPDocPDFGenerator
{
    ...
    private function categorizeFile(string $path): string
    {
        ...
        if (str_contains($path, 'Commands')) return 'Console Commands';
        if (str_contains($path, 'Resources')) return 'Filament Resources';
        if (str_contains($path, 'Pages')) return 'Filament Pages';
